...
export const ROUTER_ADDRESS = '0x33a0E10f6c59EdDe99c754E8C47f37d3008C57eE'
...
export const CAKE = new Token(
  ChainId.BSCTESTNET,
  '0xd3a39738ce944a0888dcaf128f68a8dfeaf3b7ae',
  18,
  'SCAM',
  'SCAMTEST Token'
)
export const WBNB = new Token(
  ChainId.BSCTESTNET,
  '0xf434406BCae0eBbB771d583b6F9c9466579c1629',
  18,
  'WTEST',
  'Wrapped TEST'
)
export const DAI = new Token(
  ChainId.BSCTESTNET,
  '0x3Cf204795c4995cCf9C1a0B3191F00c01B03C56C',
  18,
  'DAI',
  'Dai Stablecoin'
)
